...
| 悬停凹凸镜 | 鼠标悬停照片：卡片放大 1.08 + 以光标位置为中心的**高斯透镜凸起**（自定义 ShaderMaterial，非线性 UV 变形），透镜中心黏性跟随光标，移开平滑回落 |
...
└── src/
    ...
    ├── scene/
    │   ├── PhotoWall.js        # 圆柱阵列双面照片卡片 + 悬停/入场/浮动状态机
    │   ├── photoMaterial.js    # 照片着色器：悬停凹凸镜 + 速度畸变 + RGB 错位
